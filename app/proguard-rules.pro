...
#-keep class com.zky.basics.*
-keep class com.zky.basics** { *; }

-keep class com.refresh.lib.*
-keep class  com.refresh.lib** { *; }

-keep class com.zky.basics.common.view.*
-keep class  com.zky.basics.commonn.*{ *; }

-keep class com.zky.basics.main.entity**
-keep class com.zky.basics.main.entity** { *; }
...
-keep class com.zky.multi_media**
-keep class com.zky.multi_media** { *; }

-keep class com.zky.zky_mine.entity**
-keep class com.zky.zky_mine.entity** { *; }
