...
/**
 *create_time : 21-3-22 上午8:59
 *author: lk
 *description： TransformUtil
 */
object TransformUtil {
    ...
    private fun transformLon(x: Double, y: Double): Double {
        ...
        ret += (20.0 * sin(6.0 * x * PI) + 20.0 * sin(2.0 * x * Math.PI)) * 2.0 / 3.0
        ret += (20.0 * sin(x * PI) + 40.0 * sin(x / 3.0 * Math.PI)) * 2.0 / 3.0
